...
NetworkSlimeVolleyball = (function(_super) {
  ...
  NetworkSlimeVolleyball.name = 'NetworkSlimeVolleyball';

  function NetworkSlimeVolleyball() {
    return NetworkSlimeVolleyball.__super__.constructor.apply(this, arguments);
  }
  ...
  NetworkSlimeVolleyball.prototype.start = function() {
    var i, _i, _ref;
    for (i = _i = 0, _ref = Constants.FRAME_DELAY; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
